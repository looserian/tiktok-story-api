...
app = FastAPI(
    ...
    description=(
        "## TikTok Story API\n\n"
        "A production-ready REST API that intercepts TikTok's private Story API "
        "using a headless Chromium browser and returns clean, structured JSON.\n\n"
        "### Authentication\n"
        ...
        "### Rate Limits\n"
        "Each request spawns a full browser session and typically takes **10–20 seconds**. "
        "Plan your call frequency accordingly.\n\n"
        "### Error Format\n"
